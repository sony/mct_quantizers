...
from common.constants import FOUND_TORCH
from common.quant_info import QuantizationMethod
from logger import Logger

if FOUND_TORCH:
    import torch
    from pytorch.quantizers.base_uniform_inferable_quantizer import BaseUniformInferableQuantizer
    from pytorch.quantizer_utils import fix_range_to_include_zero, get_working_device, to_torch_tensor
