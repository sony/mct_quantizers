...
from common.constants import FOUND_TORCH, MULTIPLIER_N_BITS, EPS
from common.quant_info import QuantizationMethod


if FOUND_TORCH:
    import torch
    from pytorch.quantizers.base_lut_symmetric_inferable_quantizer import BaseLUTSymmetricInferableQuantizer
    from pytorch.quantizer_utils import to_torch_tensor, get_working_device, lut_quantizer
