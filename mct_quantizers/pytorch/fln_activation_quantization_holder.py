...
if FOUND_TORCH:
    ...
    class PytorchFLNActivationQuantizationHolder(PytorchActivationQuantizationHolder):
        """
        ...
        def forward(self, inputs):
            """
            Quantizes the input tensor using the activation quantizer of class PytorchFLNActivationQuantizationHolder.
    ...
    class PytorchFLNActivationQuantizationHolder:  # pragma: no cover
        def __init__(self, *args, **kwargs):
            Logger.critical('Installing Pytorch is mandatory '
                            'when using PytorchFLNActivationQuantizationHolder. '
