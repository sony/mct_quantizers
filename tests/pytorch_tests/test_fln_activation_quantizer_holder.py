...
class TestPytorchFNLActivationQuantizationHolderInference(unittest.TestCase):
    ...
    def test_fln_activation_quantization_holder_inference(self):
...
class TestPytorchFLNActivationQuantizationHolder(unittest.TestCase):
    ...
    def test_fln_activation_quantization_holder_save_and_load(self):
